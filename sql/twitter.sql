...
CREATE  TABLE IF NOT EXISTS `hottub`.`twitter_tweets` (
  `idtwitter_tweets` INT NOT NULL ,
  `twitter_tweets_id` BIGINT UNSIGNED NULL ,
  `twitter_tweetscol` VARCHAR(45) NULL ,
  `idtwitter_users` BIGINT UNSIGNED NULL ,
...
CREATE  TABLE IF NOT EXISTS `hottub`.`twitter_users_to_twitter_tweets` (
  `twitter_users_idtwitter_users` BIGINT NOT NULL ,
  `twitter_tweets_idtwitter_tweets` INT NOT NULL ,
  ...
  INDEX `fk_twitter_users_has_twitter_tweets_twitter_users_idx` (`twitter_users_idtwitter_users` ASC) ,
  CONSTRAINT `fk_twitter_users_has_twitter_tweets_twitter_users`
...
-- -----------------------------------------------------
-- Table `hottub`.`twitter_tweets_to_twitter_keywords`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `hottub`.`twitter_tweets_to_twitter_keywords` (
  `twitter_tweets_idtwitter_tweets` INT NOT NULL ,
  `twitter_keywords_idtwitter_keywords` INT NOT NULL ,
  PRIMARY KEY (`twitter_tweets_idtwitter_tweets`, `twitter_keywords_idtwitter_keywords`) ,
  INDEX `fk_twitter_tweets_has_twitter_keywords_twitter_keywords1_idx` (`twitter_keywords_idtwitter_keywords` ASC) ,
  INDEX `fk_twitter_tweets_has_twitter_keywords_twitter_tweets1_idx` (`twitter_tweets_idtwitter_tweets` ASC) ,
  CONSTRAINT `fk_twitter_tweets_has_twitter_keywords_twitter_tweets1`
    FOREIGN KEY (`twitter_tweets_idtwitter_tweets` )
    REFERENCES `hottub`.`twitter_tweets` (`idtwitter_tweets` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_twitter_tweets_has_twitter_keywords_twitter_keywords1`
...
-- -----------------------------------------------------
-- Table `hottub`.`twitter_users_to_twitter_mentions`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `hottub`.`twitter_users_to_twitter_mentions` (
  `twitter_users_idtwitter_users` BIGINT NOT NULL ,
  `twitter_tweets_idtwitter_tweets` INT NOT NULL ,
  PRIMARY KEY (`twitter_users_idtwitter_users`, `twitter_tweets_idtwitter_tweets`) ,
  INDEX `fk_twitter_users_has_twitter_tweets_twitter_tweets2_idx` (`twitter_tweets_idtwitter_tweets` ASC) ,
  ...
  CONSTRAINT `fk_twitter_users_has_twitter_tweets_twitter_users1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_twitter_users_has_twitter_tweets_twitter_tweets2`
    FOREIGN KEY (`twitter_tweets_idtwitter_tweets` )
    REFERENCES `hottub`.`twitter_tweets` (`idtwitter_tweets` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
